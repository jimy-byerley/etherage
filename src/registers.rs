...
pub mod al {
    ...
    pub const control: Field<AlControlRequest> = Field::simple(dls_user::r1.offset);
    pub const response: Field<AlControlResponse> = Field::simple(dls_user::r3.offset);
    pub const error: Field<AlError> = Field::simple(dls_user::r6.offset);
    pub const status: Field<AlStatus> = Field::simple(dls_user::r3.offset);
}
